...
var actorChars = {
  ...
  "y": Enemy //Added actor to mimic the coin
};
...
//Parameters for coin
var coinMaxStep = 0.05;

var coinWobbleSpeed = 8, coinWobbleDist = 0.07;

Coin.prototype.act = function(step) {
  this.wobble += step * coinWobbleSpeed;
  var coinWobblePos = Math.sin(this.wobble) * coinWobbleDist;
  this.pos = this.basePos.plus(new Vector(0, coinWobblePos));
};
